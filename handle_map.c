...
/*   Updated: 2025/01/25 20:11:12 by zbakour          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
size_t map_row_c(char *filepath)
{
	...
	while (read_line)
	{
		...
		if (trimmed_line)							// If the result is not NULL (non-empty line)
		{
			row_c++;
...
{
	if (j > 0 && ((game->map->ptr[i][j - 1] == '0' || game->map->ptr[i][j - 1] == 'P' || game->map->ptr[i][j - 1] == 'C' || game->map->ptr[i][j - 1] == 'E' || game->map->ptr[i][j - 1] == 'X' || game->map->ptr[i][j - 1] == 'G')) && game->map->ptr[i][j + 1] == '1')
		...
		render_image(game, "textures/wall_b.xpm", x, y);
	else if (j > 0 && game->map->ptr[i][j - 1] == '1' && game->map->ptr[i][j + 1] == '1')
		render_image(game, "textures/x_m_m.xpm", x, y);
	else if (j > 0 && game->map->ptr[i][j - 1] == '1' &&
			 (game->map->ptr[i][j + 1] == '0' || game->map->ptr[i][j + 1] == 'P' ||
			  game->map->ptr[i][j + 1] == 'C' || game->map->ptr[i][j + 1] == 'E' || game->map->ptr[i][j + 1] == 'G' || game->map->ptr[i][j + 1] == 'X'))
...
void render_el_at(t_game *game, int el, int x, int y)
{
	if (el == 1)
		...
		// render_image(game, "textures/env/el_2.xpm", x + 64 - 15, y  + 64 - 15 )
	...
	while (i < game->map->y && game->map->ptr[i])
	{
		...
		while (game->map->ptr[i][j])
		{
			...
			if (c == '1')
			{
				...
				if (game->map->is_sp == 1 && ((x / 64 == 12 && y / 64 == 5) || (x / 64 == 18 && y / 64 == 4)))
				{
					render_image(game, "textures/env/wall_001.xpm", x, y);

					// render_image(game, "textures/bg_64n.xpm", x, y);
				}
				else if (game->map->is_sp == 1 && (((x / 64 >= 2 && x / 64 <= 5) && y / 64 == 4) || ((x / 64 >= 2 && x / 64 <= 5) && y / 64 == 5) || ((x / 64 >= 16 && x / 64 <= 18) && y / 64 == 6) || ((x / 64 >= 16 && x / 64 <= 17) && y / 64 == 7) || (x / 64 == 20 && y / 64 == 5) || (x / 64 == 12 && y / 64 == 4) || (x / 64 == 4 && y / 64 == 6) || ((x / 64 >= 3 && x / 64 <= 4) && y / 64 == 6))) // skipe the element and render the the ground
				{
					render_image(game, "textures/bg_64n.xpm", x, y);
				}
				else if (game->map->is_sp == 1 && (((x / 64 >= 23 && y / 64 == 6) && (x / 64 <= 27 && y / 64 == 6)) || ((x / 64 >= 23 && y / 64 == 7) && (x / 64 <= 27 && y / 64 == 7)) || ((x / 64 >= 23 && y / 64 == 5) && (x / 64 <= 27 && y / 64 == 5))))
				{
					if ((x / 64 == 25 && y / 64 == 6) || (x / 64 == 27 && y / 64 == 7) || (x / 64 == 23 && y / 64 == 7))
					{
				...
				if (game->map->is_sp == 1 && ((x / 64 == 8 && y / 64 == 7) || (x / 64 == 12 && y / 64 == 2)))
				{
					render_el_at(game, 2, x, y);
					// render_image(game, "textures/env/el_2.xpm", x , y + 64 - 15 );
					// render_image(game, "textures/env/el_2.xpm", x + 64 - 15, y  + 64 - 15 );
				}
				if (game->map->is_sp == 1 && ((x / 64 == 16 && y / 64 == 2) || (x / 64 == 21 && y / 64 == 4)))
				{
		...
		while (i < game->map->y && game->map->ptr[i])
		{
			...
			while (game->map->ptr[i][j])
			{
				...
				if (c == '1')
				{
					...
					{
						// render_image(game, "textures/bg_64n.xpm", x, y);
						render_image(game, "textures/env/big_obj_1.xpm", x + 25, y);
					}
					if ((x / 64 == 17 && y / 64 == 6))
					{
						// render_image(game, "textures/bg_64n.xpm", x, y);
					...
					if ((x / 64 == 16 && y / 64 == 6))
					{
						...
						render_image(game, "textures/env/props/el_14.xpm", x, y + 45);

						render_image(game, "textures/env/plant/el_14.xpm", x, y + 40);
						render_image(game, "textures/env/plant/el_7.xpm", x, y + 85);
					}
					...
					if ((x / 64 == 18 && y / 64 == 6))
					{
						...
						render_image(game, "textures/env/props/el_1.xpm", x, y + 10);
						render_image(game, "textures/env/plant/el_10.xpm", x, y + 40);
						render_image(game, "textures/env/plant/el_16.xpm", x + 40, y + 40);
					}
					if ((x / 64 == 17 && y / 64 == 7))
					{
						render_image(game, "textures/env/props/el_12.xpm", x - 15, y + 25);
					}
					if ((x / 64 == 20 && y / 64 == 5))
					{
						// render_image(game, "textures/bg_64n.xpm", x, y);
						render_image(game, "textures/env/props/el_15.xpm", x, y);
						render_image(game, "textures/env/props/el_9.xpm", x + 38, y + 23);
					}
					if ((x / 64 == 12 && y / 64 == 4))
					{
						// render_image(game, "textures/bg_64n.xpm", x, y);
						...
						render_image(game, "textures/env/el_3.xpm", x + 10, y + 40);
						render_image(game, "textures/env/el_4.xpm", x + 35, y + 55);
					}
